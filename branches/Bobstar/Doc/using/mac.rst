...
***************************
Using Python on a Macintosh 在苹果机上使用Python
***************************
...
Getting and Installing MacPython 获取并安装MacPython
================================
...
How to run a Python script 如何运行脚本
--------------------------
...
Running scripts with a GUI 运行GUI脚本
--------------------------
