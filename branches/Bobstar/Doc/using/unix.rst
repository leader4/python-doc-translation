...
********************************
 Using Python on Unix platforms 在Unix平台上使用Python
********************************

.. sectionauthor:: Shriphani Palakodety


Getting and installing the latest version of Python 获取，安装最新版本
===================================================
...
Python-related paths and files Python相关路径和文件
==============================
