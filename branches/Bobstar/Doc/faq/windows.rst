...
有时在NT或Win95上cgi.py（或其他CGI编程）不工作！
Win95的！
------------------------------------------------------------------------
...
为什么os.popen（）/ win32pipe.popen（）在Win9x不工作？
-------------------------------------------------------
...
PyRun_SimpleFile（）导致Windows崩溃，但在Unix上不会，为什么？
-----------------------------------------------------------
